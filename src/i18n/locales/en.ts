...
export const en: DeepStringify<typeof de> = {
  ...
  ai: {
    ...
    del4Text: "Data-driven forecasts for revenue, customer behavior, and market trends — for informed business decisions.",
    ...
    project1Desc: "Intelligent chatbot with GPT integration that automatically answers 70% of all customer inquiries and increases customer satisfaction by 35%.",
    ...
    project3Desc: "Computer vision system for automatic defect detection in production with real-time analysis and reporting.",
    project4Title: "AI-Powered Business Intelligence",
    project4Desc: "Intelligent data analysis platform with natural language queries and automatic insights for management.",
  ...
  web: {
    ...
    del2Text: "Modern frontend and backend development with React, Next.js, Node.js, and other technologies.",
