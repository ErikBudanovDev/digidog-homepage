...
const services = [
  {
    ...
    title: "Replace SaaS",
    subtitle:
      "Stop paying for features you don't use. We build AI-operated tools you own — CRM, task management, lead pipelines — on infrastructure you control.",
    deliverables: [
      "Audit your current SaaS stack for replaceable spend",
      "Build custom AI-operated replacements (CRM, PM, email)",
      "Self-hosted on your own VPS with full data ownership",
      "MCP server architecture for AI-first workflows",
      "PostgreSQL database replacing siloed SaaS data",
      "Docker deployment with automated backups",
      "Ongoing monitoring and system evolution",
    ],
    result:
      "Lower costs, full data ownership, and systems that actually fit how your business works.",
  ...
  },
  {
    ...
    subtitle:
      "Lead follow-ups, reporting, task routing, client onboarding — running automatically without you touching a dashboard.",
    deliverables: [
      "Map your workflows and identify automation opportunities",
      "AI agents for lead qualification and follow-ups",
      "Automated reporting and business intelligence",
      "Cross-platform orchestration (email, CRM, PM, Slack)",
      "Custom AI assistants trained on your business data",
      "Error handling and human fallback systems",
      "Performance monitoring and continuous improvement",
    ],
    result:
      "What used to take 5 tools and 3 hours now takes one prompt. Fewer dropped tasks, faster response times.",
  ...
  },
  {
    ...
    subtitle:
      "Your data, your server, your rules. We build revenue infrastructure — websites, dashboards, and platforms — that you control completely.",
    deliverables: [
      "Custom websites built for conversion and speed",
      "Full-stack web applications and internal tools",
      "API integrations connecting your existing systems",
      "Multi-site management through AI interfaces",
      "Performance optimization and technical SEO",
      "Deployment on infrastructure you own",
      "No vendor lock-in, no platform risk",
    ],
    result:
      "A fast, secure digital platform you own — not rented from someone else's roadmap.",
